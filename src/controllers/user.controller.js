...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // find the user with username/email from DB
  // compare the password from the body to the password from the database
  // give access and refresh token when data is matched
  // send cookie
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  if (!user) {
    throw new ApiError(500, "user not found after updating avatar");
  }
